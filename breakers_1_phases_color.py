try:
    ...
    def color_by_individual_or_by_panel():
        ...
        x = input("""Looking for line color by individual breaker
or the line color of all breakers in the whole panel?
Enter "p" for panel or "i" for individual breake \n""").lower()

        color = [0, 'Black color for line A', 'Red   color for line B']
        ...
        if x == 'p':  # p = panel
            ...
            if number <= 0:
                ...
                print('The colors for the lines on the breakers are; \n')
                for number in numbers:
                    if number % 2 == 1:
                        number_impar_black = number

                        print(color[1], 'on breaker num ',
                            number_impar_black, ' and ', number_impar_black + 1)

                    numbers_impar_red = [*range(3, number + 4, 4)]
                    for number in numbers_impar_red:
                        if number % 2 == 1:
                            number_impar_red = number
                    print(color[2], 'on breaker num ',
            ...
            b = 'The line color is black for breaker # '
            r = 'The line color is red for breaker # '
